...
import { off, on, throttle } from "@/components/table/util";

export const useTable = (props) => {

  /** Table 实例 */
  const pxTable = ref(null);
  ...
  const initColumns = () => {
    ...
    _table_width.value = el && el.offsetWidth;
